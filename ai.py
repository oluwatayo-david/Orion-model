...
def initialize_llm():
    ...
    Settings.embed_model = GeminiEmbedding(
        model_name="models/embedding-001", api_key=api_key, title="this is a new document"
    )
...
def sendAnalysis():
    ...
    try:
        analysis = query_engine.query('Analyze the transaction history provided below and give a comprehensive analysis on my spending and also give some advice how to spend the money better. The context to analyze:' + content)
